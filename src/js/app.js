  ...
  fetch(
    ...
    .then(function(data) {
      ...
      for (let i = 0; i < 40; i += 8) {
        ...
        console.log(
          Math.round(parseFloat(data.list[i].main.temp) - 273.15) + "°C"
        );
      }
...
export function getData(cityName, day, unit) {
  const key = "5a61784f731702ae57e794e5dceb17ab";
  return fetch(
    "https://api.openweathermap.org/data/2.5/forecast?q=" +
      cityName +
    ...
    .then(function(data) {
      ...
      let indexOfThePassedDay = Object.values(Object.values(data)[3]).findIndex(
        item => {
      ...
      // return {days, temperatures, humidity, unit};
      return { days, temperatures, humidity, unit };
    })
    .catch(function() {
      // catch any errors
